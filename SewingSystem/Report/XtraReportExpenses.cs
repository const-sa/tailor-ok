...
{
    public partial class XtraReportExpenses : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportExpenses()
        {
            InitializeComponent();
          
        }

        private void XtraReportExpenses_BeforePrint(object sender, CancelEventArgs e)
        {
