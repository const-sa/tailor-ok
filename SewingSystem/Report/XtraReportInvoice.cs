...
{
    public partial class XtraReportInvoice : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportInvoice()
        {
            InitializeComponent();
            
        }

        private void XtraReportInvoice_BeforePrint(object sender, CancelEventArgs e)
        {
