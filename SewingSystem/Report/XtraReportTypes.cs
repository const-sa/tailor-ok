...
{
    public partial class XtraReportTypes : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportTypes()
        {
            InitializeComponent();
             
        }
        
        private void XtraReportTypes_BeforePrint(object sender, CancelEventArgs e)
        {
