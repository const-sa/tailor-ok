...
{
    public partial class XtraReportCustomer : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportCustomer()
        {
            InitializeComponent();
            
        }

        private void XtraReportCustomer_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            this.ApplyLocalization(Properties.Settings.Default.Language);
            lbl_user.Text = Program.User.UserName;
